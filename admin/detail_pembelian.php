...
<head>
    ...
    <style>
        ...
        .table-detail th { background: #f8f9fa; font-size: 12px; font-weight: 700; color: #8d9498; text-transform: uppercase; padding: 15px 10px !important; }
    </style>
</head>
<body>
<div class="wrapper">
                            ...
                            <ul class="dropdown-menu dropdown-user animated fadeIn">
                                <div class="dropdown-user-scroll scrollbar-outer">
                                    <li>
                                        <div class="user-box">
                                            <div class="avatar-lg">
                                                <img src="<?= $foto ?>" alt="image profile" class="avatar-img rounded" onerror="this.src='assets/img/profil/default.png'" />
                                            </div>
                                            <div class="u-text">
                                                <h4><?= $nama ?></h4>
                                    ...
                                    <table class="table table-hover table-bordered table-detail mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center" style="width: 20%;">QTY RENCANA</th>
